...
2. **Encoded Revision & Unique User Hash**
   ...
   * Example `*aid`
     ...
     * `lkbpmYoyhVM6` → Base64-encoded user hash
...
3. **Set up a hosting backend** for storing and serving avatars. \
...
4. **Use a dedicated subdomain for federated avatar sharing**. \
...
5. **Add your project's information to the participants list**. \
